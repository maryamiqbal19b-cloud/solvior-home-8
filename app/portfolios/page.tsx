...
export const metadata: Metadata = {
  title: "Portfolios — Solvior",
  description: "Explore Solvior's portfolio of breakthrough client projects across strategy and growth consulting.",
};
    ...
    <>
      ...
      <section className="relative bg-[#0B1B33] text-white px-6 md:px-10 py-28 text-center overflow-hidden">
        ...
        <div className="relative">
          <h1 className="font-display text-4xl md:text-5xl font-bold mb-5">Portfolios</h1>
