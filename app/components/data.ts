...
export const PROJECTS = [
  {
    ...
    img: "/h8-project-1.webp",
    client: "Albert Buttler",
    category: "Marketing",
    service: "Corporate",
    date: "08 March 2026",
    summary: "Transforming operational efficiency with strategic edge solutions for businesses.",
  },
  {
    slug: "strat-edge-solutions",
    title: "Strat Edge Solutions",
    tags: ["Strategy", "Growth"],
    img: "/h8-project-2.webp",
    client: "Marvin McKinney",
    category: "Consulting",
    service: "Strategy",
    date: "14 April 2026",
    summary: "Building a sharper competitive edge through data-driven strategic planning.",
  },
  {
    slug: "prime-strategy-partners",
    title: "Prime Strategy Partners",
    tags: ["Strategy", "Growth"],
    img: "/h8-project-3.webp",
    client: "Courtney Henry",
    category: "Finance",
    service: "Advisory",
    date: "02 May 2026",
    summary: "Partnering on a long-term growth roadmap backed by rigorous market research.",
  },
  {
    slug: "elevate-enterprise",
    title: "Elevate Enterprise",
    tags: ["Strategy", "Growth"],
    img: "/h8-project-4.webp",
    client: "Jacob Jones",
    category: "Operations",
    service: "Process",
    date: "19 May 2026",
    summary: "Elevating enterprise operations with streamlined, automation-first workflows.",
  },
  {
    slug: "empower-enterprise",
    title: "Empower Enterprise",
    tags: ["Strategy", "Growth"],
    img: "/h1-project-2.webp",
    client: "Ronald Richards",
    category: "Leadership",
    service: "Coaching",
    date: "03 June 2026",
    summary: "Empowering leadership teams with the tools to run change with confidence.",
  },
  {
    slug: "innovative-solutions",
    title: "Innovative Solutions",
    tags: ["Strategy", "Growth"],
    img: "/h1-project-4.webp",
    client: "Cameron Williamson",
    category: "Technology",
    service: "Digital",
    date: "21 June 2026",
    summary: "Delivering innovative digital solutions that scale with business growth.",
  },
];
